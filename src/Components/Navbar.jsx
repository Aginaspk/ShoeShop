...
function Navbar() {
  ...
  return (
    <div className='overflow-x-hidden w-full fixed z-20 top-0 bg-white'>
      ...
      {/* sidebar */}
      <div className={`fixed top-0 left-0  w-100% h-screen bg-[#CF4616] z-50 2xl:hidden sm-xl:hidden block transform transition-transform duration-300  ${!isSidebarOpen ? "translate-x-full" : "translate-x-0"}`}>
        ...
        <div className='w-full flex justify-between border-black border-[1px]'>
          ...
          <div className='flex'>
            ...
            <div className='text-[16px] flex list-none'>
              <li className='px-3 py-4 2xl:block hidden'>Men</li>
              <li className='px-3 py-4 2xl:block hidden'>Woman</li>
              <Link to={'/products'}><li className='px-3 py-4 2xl:block hidden'>Sales</li></Link>
              <li className='px-3 py-4 2xl:block hidden'>Stories</li>
            </div>
          </div>
          <div className='flex'>
            <div className='2xl:px-4 md:px-4 px-2 py-2 text-lg relative 2xl:block sm-xl:block hidden'>
            ...
            <div className='2xl:px-4 md:px-4 px-2 py-2 text-4xl text-[#1A2508] relative'><FontAwesomeIcon icon={faHeart} /><p className='text-sm text-white absolute right-[21px]  2xl:right-[28px] top-[18px] md:right-[28px] '>0</p></div>
            <div className='2xl:px-4 md:px-4 px-2 py-[6px] text-4xl text-[#1A2508] relative'><FontAwesomeIcon icon={faBagShopping} /><p className='text-sm text-white absolute right-[19px] 2xl:right-[26px] top-[22px] md:right-[26px]  '>0</p></div>
            <div className=' 2xl:hidden md:hidden 2xl:px-4 md:px-4 px-2 py-2 text-4xl text-[#1A2508]' onClick={openSideNav}><FontAwesomeIcon icon={faBars} /></div>
            <div className='px-4 py-2 2xl:block md:block hidden'><div className='flex items-center justify-center w-10 h-10 rounded-full bg-[#1A2508] text-xl text-white font-semibold'><FontAwesomeIcon icon={faUser} /></div></div>
